"""Vault — the precompiled tool-surface package a enclave-generated program
...
`from vault import *` contract (used verbatim in enclave-system.md and every
...
and must match enclave/resources/enclave-system.md exactly.
"""
