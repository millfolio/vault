#!/usr/bin/env bash
# privacy_box sandbox spike — prove the code-runner containment boundary on macOS.
#
# Renders sandbox/privacy_box.sb.template against a throwaway demo layout and runs
...
echo "privacy_box sandbox spike  (profile: $PROFILE)"
