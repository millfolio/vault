...
///      pkgs + flare + a prebuilt libflare_tls.so), build the server with
...
public final class Bootstrapper: ObservableObject {
    ...
    public func installServer() async throws {
        ...
        try buildBinary(python: python, source: "src/server.mojo",
                        args: ["-I", "../pkgs", "-I", "../flare"], out: "build/millfolio-inference")
        signServerIdentity()
    ...
    /// vendored flare/json/pkgs + prebuilt FFI shims.
